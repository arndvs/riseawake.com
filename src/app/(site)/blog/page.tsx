      ...
      <Container>
        ...
        <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {featuredPosts.map((post) => (
            <div
              key={post.slug}
              className="relative flex flex-col rounded-3xl bg-surface p-2 shadow-card ring-1 ring-edge transition-all duration-300 hover:shadow-lg hover:ring-brand/25"
            >
              {post.mainImage && (
                <img
