...
After resolving, run whatever checks you think are warranted — typecheck is fast and catches most resolution mistakes; tests if you want stronger confidence. You decide. If something is broken, fix what you can; if you can't, push what you have and flag it clearly in the comment.
